...
namespace Louvor.IPI.Persistence.Context
{
public partial   class LouvorContext : DbContext, ILouvorContext

    {
      public  LouvorContext()
        {
        }

        public LouvorContext(DbContextOptions<LouvorContext> options)
            :
            base(options)
        {
        }
